...
class Factory {
  ...
  static customerBuild(color, car, options) {
    console.log(
      `Building one ${color} ${car.trim} ${car.model} with the following options: ${options}`
    )
  }
}

Factory.massBuild(100, { color: "red", model: "CX-5", trim: "Touring" })
...
Factory.customerBuild("yellow", { trim: "Touring", model: "Mazda3" }, [
...
Factory.customerBuild("black", { trim: "Grand Touring", model: "Miata-RF" }, [
